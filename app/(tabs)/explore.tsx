...
export default function ExploreScreen() {
  ...
  const memories = useSelector((state: any) => state.memories.memories);
    ...
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <View style={styles.statsRow}>
        ...
        >
          ...
          <Text style={[styles.statLabel, { color: theme.subtitle }]}>
            Memories
          </Text>
        </View>
        <View
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              <View style={styles.recentContent}>
                <Text
                  style={[styles.recentSummary, { color: theme.text }]}
                  numberOfLines={1}
                >
                ...
                {item.reminderAt ? (
                  <Text
                    style={[styles.recentReminder, { color: theme.accent }]}
                    numberOfLines={1}
                  >
                    Reminder: {new Date(item.reminderAt).toLocaleDateString()}
                  </Text>
                ) : null}
...
const styles = StyleSheet.create({
  ...
  recentReminder: { fontSize: 11, marginTop: 4, fontWeight: "500" },
